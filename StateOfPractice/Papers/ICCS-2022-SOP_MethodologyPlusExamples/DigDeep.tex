...
506]{GhezziEtAl2003}. The tools found for LBM software packages are as follows:
...
Once the data on tools is collected, two specific tools that can be compared to
research software norms are version control and continuous integration.
