...
%\documentclass[draft, review, 12pt, 3p, times]{elsarticle} %so figures are blank, double spaced
...
\begin{figure*}[ht!]
\includegraphics[scale=0.67]{template}
...
\begin{figure*}[ht!]
\includegraphics[scale=0.47]{overall_scores}
