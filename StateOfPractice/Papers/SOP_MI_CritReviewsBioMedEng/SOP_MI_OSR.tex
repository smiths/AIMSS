...
\cite{smith2018statistical}.  %% DOUBLE BLIND 
...
template~\cite{SmithEtAl2021}.    %%DOUBLE BLIND
...
AHP below and in longer form in Smith et al.\ (2024)~\cite{SmithEtAl2024_MI_SOP}.
%% DOUBLE BLIND
...
inaccurate.  The expert also vets the AHP ranking.  Our Domain Expert (and
...
Engineering at St.\ Joseph's Healthcare, Hamilton, Ontario, Canada.  %%DOUBLE BLIND 
...
We use an existing template \cite{SmithEtAl2021} %% DOUBLE BLIND
...
hours on the installation process.  We explicitly note any software that cannot be installed, but for completeness we still measure it for the remaining qualities, since only reliability and robustness require running the software. Figure~\ref{fg_grading_template_example}
shows an excerpt of the measurement spreadsheet.  The rows are the measures and
the columns correspond to the software packages.  Dong (2021)~\cite{Dong2021-Data}
...
Smith et al. \cite{SmithEtAl2021}. %%DOUBLE BLIND
...
equally important.  (Alternative priority schemes can be investigated by changing the
...
al.~\cite{SmithEtAl2024_MI_SOP}. %% DOUBLE BLIND
...
number of people watching the projects as proxies for community ranking.  We considered also comparing software citations, but this measure of popularity would be unreliable since software is infrequently and inconsistently cited~\cite{SmithEtAl2016-softcite}.
Table~\ref{tab_ranking_vs_GitHub} show the statistics for GitHub data collected in July
2021.
...
Besides the installation problem, another possible reason for discrepancies between our ranking and GitHub popularity is that we weighted all qualities equally, which is not the likely the same weighting
...
We interview developers, as described in Section~\ref{sec_interview_methods}, to answer \rqref{RQ_CompareToolsProjMngmnt} (tool usage),
...
found in Dong (2021)~\cite{Dong2021}. %%DOUBLE BLIND
...
(LBM) software~\cite{Michalski2021}. %%DOUBLE BLIND
This contrasts with the high frequency of guidelines recommending continuous
integration
\cite{BrettEtAl2021, ThielEtAl2020, vanGompelEtAl2016, Brown2015, Zadka2018}.
...
document generation tools, like doxygen and sphinx~\cite{Michalski2021}. %%DOUBLE BLIND
...
software developers often use an agile philosophy \cite{HeatonAndCarver2015, CarverEtAl2007, AckroydEtAl2008, EasterbrookAndJohns2009, Segal2005}, or an
...
Dong (2021)~\cite{Dong2021} %%DOUBLE BLIND
...
software~\cite{Michalski2021} %%DOUBLE BLIND
...
reproducibility, and software scope determination.  Smith et al.\ (2024)~\cite{SmithEtAl2024} 
...
is not uncommon
\cite{SmithEtAl2024, WieseEtAl2019, PintoEtAl2018, PintoEtAl2016}.
%DOUBLE BLIND
...
research software. This is a common complaint~\cite{SmithEtAl2024, GewaltigAndCannon2012, Goble2014, KaterbowAndFeulner2018}. %,  %DOUBLE BLIND
...
LBM software developers \cite{SmithEtAl2024}. %%DOUBLE BLIND
...
Network (CRAN)~\cite{SmithEtAl2018_StatSoft}. %%DOUBLE BLIND
...
averages around 30--35\% for the efficiency of defect removal \cite{Jones2008, EbertAndJones2009}. For research software, Kelly and Shepard \cite{KellyAndShepard2000}
...
reproducible.
%% DOUBLE BLIND
Smith et al.~\cite{SmithEtAl2016} reports grading five software products by two reviewers.
...
approach to developing LBM software \cite{SmithEtAl2024} 
%% DOUBLE BLIND
