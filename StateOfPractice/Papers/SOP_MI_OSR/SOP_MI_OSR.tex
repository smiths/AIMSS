...
In particular we provide details on recommended artifacts but rarely observed
...
installation instructions. But we were able to use its web
...
We use nine research software development guidelines to measure what
software artifacts are present in MI software, versus those recommended.
...
It groups the artifacts by frequency
...
Three of the 26 recommended artifacts were never observed:
...
It is unfortunately common for research software to neglect requirements
documentation, and MI software is no exception.
Although such documentation is recommended by some
\cite{TobiasEtAl2018, HerouxEtAl2008, SmithAndKoothoor2016}, in practice
this is rare~\cite{HeatonAndCarver2015}. Sanders and Kelly
...
\cite{Nguyen-HoanEtAl2010}. 

This is quite unfortunate as when surveyed, research software developers
identify the lack of requirements and requirements management as accounting
gets mentioned the most often and accounts for 23\% of the technical problems
\cite{WieseEtAl2019}.  There is unfortunately widespread perception that
up-front requirements are impossible for research software
\cite{CarverEtAl2007, SegalAndMorris2008}. Fortunately a more agile approach
to requirements is feasible~\cite{Smith2016}, and research-software specific
templates exist~\cite{SmithEtAl2007}. 
...
Other communities use checklists to help with best practices. Examples
include checklists for
merging branches~\cite{Brown2015},
for saving and sharing changes to the project~\cite{WilsonEtAl2016},
for new and departing team members~\cite{HerouxAndBernholdt2018},
for processes related to commits and releases~\cite{HerouxEtAl2008}
and for overall software quality~\cite{ThielEtAl2020, SSI2022}.

MI projects fall somewhat short of recommended best practices, but are not
alone amongst research software projects. This gap has been
documented before~\cite{Storer2017,JohansonAndHasselbring2018}, is known
to cause sustainability and reliability
problems \cite{FaulkEtAl2009}, and to waste development effort%
...
A study is reliable if repeated by another researcher, using the same
...
\item The measurements for the full set of packages took several months
(of elapsed time).
...
no alternative for \textit{DICOM Viewer}.
...
\begin{itemize}
\item Our search (Section~\ref{ch_results}) may
...
study is externally valid \cite{RunesonAndHost2009}.  In other words, cannot
...
Our analysis of the state of the practice for the MI domain along nine
software qualities strongly indicates that ``higher quality'' is
consistent with community ranking proxies. It is important to note that
our quality measures are, on purpose, rather shallow. This undescores the
importance that \emph{first impressions} of any software has on its
adoption.
