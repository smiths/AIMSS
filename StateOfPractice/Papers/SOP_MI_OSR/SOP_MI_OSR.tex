...
(Section~\ref{sec_grading_software}) on qualities using AHP;
\end{enumerate}

define software qualities and ahp.
...
Details on how we measure each quality are provided in \citet{SmithEtAl2024}.
...
\subsubsection{Software Quality Definitions} \label{sec_software_quality}
...
\citep{ISO/IEC25010, lenhard2013measuring}.  Further details on the software
qualities can be found in \citet{SmithEtAl2024}.
