...
applications. Through MI medical practitioners and
...
software with the hope of highlighting standout examples, and providing
...
chasm, between software engineering and research software \cite{Storer2017}. Although scientists spend a substantial proportion of their working
...
has been applied to MI software and Lattice Boltzmann Solvers
\cite{SmithEtAl2024}.  This methodology builds off prior work to assess the
...
\cite{smith2018statistical}.  In keeping with the previous methodology, we have
...
\href{https://github.com/boyter/scc}{Sloc Cloc and Code (scc)}.  Details on how
we measure each quality are provided in Smith et al.\ (2024)
\cite{SmithEtAl2024_MI_SOP}.
...
with almost 40\% of projects (11 of 29).  The two least popular choices are
Pascal and Matlab, with around 3\% of projects each (1 of 29).
