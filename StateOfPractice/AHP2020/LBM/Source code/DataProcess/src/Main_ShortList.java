...
public class Main_ShortList {
	
	public static void main(String[] args)
    {
		int numberQualities = 2;
		int numberSoftwarePackages = 7; //also need to change rownum below
        ...
        try
        {
            FileInputStream file = new FileInputStream(new File("AHP_ShortList.xlsx"));
            ...
            try
            {
                ...
                FileOutputStream out = new FileOutputStream(new File("AHP_ShortList.xlsx"));
                workbook.write(out);
                out.close();
            }
            catch (Exception e)
