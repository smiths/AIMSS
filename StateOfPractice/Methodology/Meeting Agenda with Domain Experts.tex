...
\noindent Refer to Section \ref{project_objectives}
...
\noindent Refer to Section \ref{research_proposal}
...
\noindent Refer to Section \ref{research_questions}
...
\subsection{Review the Modifiability Experiment}
