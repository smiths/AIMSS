...
\authorrunning{Smith et al.}  \Copyright{Spencer Smith and Jacques Carette and
 Peter Michalski and Ao Dong and Olu Owojaiye}
...
\bibliography {Methodology_arXiv_version}

\end{document}

Thoughts - add the recent research on pain points (Pinto et al, 2018 and Wiese
et al 2020), contrast the current study to others - the others try to cover all
research software, we are focusing on specific domains