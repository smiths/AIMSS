...
Go through each quality and describe how it will be measured.

Start with decided upon definition.  (If discussion is on-going, please select
the ``best'' definition, but include a warning that it may change.)
