...
The purpose of our proposed methodology is to gain insight on how software
quality is impacted by the software development principles, processes and tools
currently used within research software communities.  Since research software is
so broad a category, we will reduce the scope of each application of the
methodology by applying it to a specific domain within research software.  This
``state of the practice for domain X'' exercise will build off of prior work on
measuring/assessing the state of software development practice in several
research domains.  We will update the work that was done previously for domains
...
Statistical software for psychology \citep{SmithEtAl2018_StatSoft}.

In the previous project, we measured 30 software projects for each domain, but
the measures were relatively shallow.  With this re-boot we are adding more
measures and experiments.  refining the list
into a short list of the best projects for more detailed measurement.  More details.
