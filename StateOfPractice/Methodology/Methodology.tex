...
systems so that we can better understand and predict the system's behaviour.  A
small sample of some important examples of research software include the
following: designing new automotive parts, analysing the flow of blood in the
...
for sustainable development practices.  This is evident from the existence of
such groups as SEI, BME.  Groups promoting sustainable practices are necessary
because the current state-of-the-practice for research software does not
incorporate state-of-the-art SE tools and methods
...
improve this situation, we need to more fully understand the current state of
...
the measures were relatively shallow.  With the re-boot we will refine the llist
