...
\pmi{do we have specific examples of other people considering performance benchmarks?}
...
\pmi{comments from meeting: this part is to `enable conversation'; the ranking starts the conversation - `why do they like this software'; yes to tool question - spreadsheet; enable conversation regarding what's good about the specific softwares (also important highlights of domain software?)}

An AHP pairwise comparison between the short list packages with respect to usability and modifiability survey results is conducted by the domain expert. The tool can be found here. The usability and modifiability survey can be found \href{https://github.com/smiths/AIMSS/blob/master/StateOfPractice/Methodology/Experiments.pdf}{here}. 
