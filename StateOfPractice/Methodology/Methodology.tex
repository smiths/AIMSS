...
\begin{enumerate}
\item Start with state of practice research questions. (Section~\ref{ResearchQuestions}) \pmi{To be completed; should I remove section 2 from above and just link to ../OverallResearchProposal/ObjectivesAndResearchQuestions.pdf?, move the doc to this folder?}
...
\end{enumerate}
\item Rank short list. (Section~\ref{SecRankShortList}) \pmi{To be completed; how will we do this? status of usability experiments?}
