...
applied to ranking software based on quality measures. We have developed a
...
% \begin{tabular}{p{14cm}}
% \hline
% \textbf{Repo Metrics (Measured via git_stats)}\\
% \hline
% Number of text-based files. (number)\\
% Number of binary files. (number)\\
% Number of total lines in text-based files. (number)\\
% Number of total lines added to text-based files. (number or {not git repo})\\
% Number of total lines deleted from text-based files. (number or {not git repo})\\
% Number of total commits. (number or {not git repo})\\
% Numbers of commits by year in the last 5 years. (Count from as early as possible if the project is younger than 5 years.) (list of numbers or {not git repo}\\
% Numbers of commits by month in the last 12 months. (list of numbers or {not git repo})\\
% \hline
% \end{tabular}
...
% \begin{tabular}{p{14cm}}
% \hline
% \textbf{Repo Metrics (Measured via scc)}\\
% \hline
% Number of text-based files.	(number)\\
% Number of total lines in text-based files.	(number)\\
% Number of code lines in text-based files.	(number)\\
...
% \textbf{Repo Metrics (Measured via GitHub)}\\
% \hline
% Number of stars.	(number or {n/a})
% Number of forks.	(number or {n/a})
% Number of people watching this repo.	(number or {n/a})
% Number of open pull requests.	(number or {n/a})
% Number of closed pull requests.	(number or {n/a})
% \hline
% \end{tabular}
