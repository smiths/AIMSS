...
\pmi{Comment from meeting: Instead of identify likely changes, start with Domain Expert about the likely changes they might make (in such a domain?)(write all down), take that list and see which of those likely changes the software is most likely designed for}
