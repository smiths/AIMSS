...
\begin{longtable}{p{16cm}}
  ...
  Are the majority of identified bugs fixed? (\{yes, no$^*$, unclear\})\ad{It might be better to record a number here}\\
  What is the percentage of identified issues that are closed? (percentage)\ad{an example}\\
