...
%   For instance,
% ATLAS (Automatically Tuned Linear Algebra Software) \citep{WhaleyEtAl2001} 
%and
%Blitz++ \citep{Veldhuizen1998} 
% produces efficient and portable linear algebra
% software.  
% Spiral \citep{Pueschel2001} uses software/hardware generation for
